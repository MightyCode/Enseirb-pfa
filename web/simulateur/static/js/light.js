export default class Light {
    constructor(id, _element) {
        // Check types
        if (typeof id !== 'number')
            throw new TypeError('Light ID must be a number');
        if (typeof _element !== 'object')
            throw new TypeError('Light element must be an object');
        this._id = id;
    ...
    set rgbw(rgbw) {
        // Check type
        if (!(rgbw instanceof Uint8Array))
            throw new TypeError('Light color must be a Uint8Array');
        this._rgbw = rgbw;
